...
public interface CalendarDateRepository extends JpaRepository<CalendarDate, Long> {
    ...
    @Query(nativeQuery = true, value = "select * from calendar_date inner join calendar_year cy on cy.year = calendar_date.calendar_year_year where day = :day and month = :month and year = :year limit 1")
